...
import { sidebarConfig, SidebarContext } from '@backstage/core-components';
import { SidebarItemWithSubmenuContext, submenuConfig } from './config';
...
export const SidebarSubmenu = (props: SidebarSubmenuProps) => {
  ...
  const { isHoveredOn, isClickedOn } = useContext(
  ...
  useEffect(() => {
    setIsSubmenuOpen(isSidebarActive);
  }, [isSidebarActive]);
